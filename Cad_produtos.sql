...
WHERE
    ...
    AND T0."validFor" >= [%0]  
/*GROUP BY
    T0."ItemCode", T0."validFor", T0."U_CbxForaLinha", T0."SellItem", T0."U_Tx_Linha", 
    T0."U_Tx_Colecao", T1."ItmsGrpNam", T0."U_CVA_Desc_SubGrupo", T0."ItemName",
    T0."U_ItemSubstituto", T0."U_MotivoSubstituicao", T0."BuyUnitMsr", T0."U_TX_UTribEx",
    T0."U_TX_FtTribEx", T2."NcmCode", T0."U_TX_CodigoCest", T4."U_IPI_VALUE", 
    T0."ProductSrc", T3."ISOriCntry", T0."U_NumInmetro", T0."U_ItemComposicao", 
    T0."BVolume", T0."BWeight1", T0."SWeight1", T0. "U_ItemMacro",     T0."U_InnerCodBarras",
    T0."U_MasterCodBarras", T0."U_ProdCodBarras", T0."U_EmbCodBarras", T6."UpdateDate"*/
ORDER BY
    T0."ItemCode"